...
2-6,4-8""".lines()
    ...
    fun `should decide if one assignment is contained entirely within the other`(assignmentPair: String, isOverlapping: Boolean) {
        assertThat(CampCleanup.assignmentIsDuplicated(assignmentPair)).isEqualTo(isOverlapping)
    }
